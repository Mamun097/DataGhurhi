...
const EditProject = () => {
  ...
  const handleAddSurveyClick = async () => {
    ...
    const t = {
      ...
      validation:
        translatedLabels["Title is required!"] || "Title is required!",
      successMsg:
        translatedLabels["✅ Survey created successfully!"] ||
        "✅ Survey created successfully!",
      errorMsg:
        translatedLabels["❌ Failed to create survey."] ||
    ...
    const result = await Swal.fire({
      ...
      inputValidator: (value) => {
        if (!value) {
          return language === "English" ? "Title is required!" : t.validation;
        }
      },
    });
    ...
    if (result.isConfirmed && result.value) {
      ...
      try {
        ...
        alert(
          language === "English" ? "❌ Failed to create survey." : t.errorMsg
        );
      }
    }
  };
