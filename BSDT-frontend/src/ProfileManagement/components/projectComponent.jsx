...
const ProjectTab= ({getLabel, handleAddProjectClick,
                    privacyFilter,sortField,setProjects
   ,                 sortOrder,projects,setSortOrder,setSortField,
    ...
    const handleDeleteProject = (projectId) => {
      ...
      if (window.confirm(getLabel("Are you sure you want to delete this project? This action cannot be undone."))) {
        fetch(`http://localhost:2000/api/project/${projectId}/delete-project`, {
          ...
          .then((response) => {
            if (!response.ok) {
              throw new Error(getLabel("Failed to delete project. Please try again."));
            }
                      ...
                      <div className="project-grid">
                        {projects
                          ...
                          .map((project) => (
                            ...
                            >
                              <div onClick={() => handleProjectClick(project.project_id, "owner")}>
                                <h4>{project.title}</h4>
                                <p>
