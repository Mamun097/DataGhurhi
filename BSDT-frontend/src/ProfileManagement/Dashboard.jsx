...
const Dashboard = () => {
  ...
  const loadTranslations = async () => {
    ...
    const labelsToTranslate = [
      ...
      "Saved Files",
      "Premium Packages",
      "Projects and surveys shared with you",
      "Search collaborated projects...",
      "View Requests",
      "No Collaborated Projects",
      "Owner",
      ...
      "Editor",
      "My Surveys",
      "Create and manage surveys within this project",
      "New Survey",
      "AI Generate",
      "Search surveys...",
      "Status:",
      ...
      "Enter survey title...",
      "Create",
      "LLM Survey Generator",
      "Hi! I can generate a full survey using AI. Want to give me some info?",
      "Perfect! Generating your survey...",
  ...
  const getTabs = () => {
    if (isAdmin) {
      ...
      return [
        ...
        {
          label: getLabel("Collaborations"),
          key: "shared",
          icon: <Users size={18} />,
          badge: collabRequests.length,
        },
        {
          label: getLabel("Question Bank"),
          key: "questionbank",
          icon: <Package size={18} />,
        },
        {
        ...
        {
          label: getLabel("Saved Files"),
          key: "saved-files",
          icon: <Folder size={18} />,
        },
        {
          label: getLabel("Premium Packages"),
          key: "premiumpackages",
          icon: <Crown size={18} />,
        },
      ];
