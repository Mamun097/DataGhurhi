...
const QuestionContainer = ({
  ...
  case "radio": {
    ...
    // If options are plain strings, convert to Option objects
    if (options.some((opt) => typeof opt === "string")) {
      options = options.map((opt) => new Option(getLabel(opt), 0));
    }

    // If still empty, create default Option objects
    if (options.length === 0) {
      options = [
    ...
    case "text":
      ...
      case "linearScale":
        ...
        commonProps.question.meta.leftLabel = question.meta.leftLabel || getLabel("Poor");
        commonProps.question.meta.rightLabel = question.meta.rightLabel || getLabel("Excellent");
      ...
      case "tickboxGrid":
        ...
        commonProps.question.meta.columns =
