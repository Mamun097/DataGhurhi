...
const renderAnovaResults = (anovaActiveTab, setAnovaActiveTab, results, language, user_id, testType, filename, columns) => {
    ...
    // All the chart rendering functions (renderCountChart, renderMeanChart, CustomBoxPlot, CustomViolinPlot)
    // would be identical to the Kruskal version, so I'm including them here but commented for brevity
    // In actual implementation, copy them exactly from the Kruskal component
    ...
    const renderMeanChart = () => {
        // Same implementation as Kruskal
