...
const MosaicPlot = ({
    ...
    // Generate mosaic data from results
    const generateMosaicData = () => {
        ...
        if (!selectedResult) {
            // For Cramer's V, we might want to prioritize strong associations
            selectedResult = results.pairwise_results.find(r => r.cramers_v > 0.3) // Strong association
                || results.pairwise_results.find(r => r.p_value < settings.significanceAlpha)
                || results.pairwise_results[0];
        }

        // Get contingency table data
        const var1Categories = selectedResult.var1_categories || selectedResult.categories_var1 || ['Cat A', 'Cat B', 'Cat C'];
        const var2Categories = selectedResult.var2_categories || selectedResult.categories_var2 || ['Type 1', 'Type 2', 'Type 3'];
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                {mosaicData.pValue?.toFixed(4) || 'N/A'}
                            </div>
                            <div style={{
                                fontSize: '11px',
