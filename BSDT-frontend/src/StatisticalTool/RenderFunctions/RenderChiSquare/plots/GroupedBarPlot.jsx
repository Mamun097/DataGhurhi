        ...
        <div style={{ position: 'relative', width: '100%' }}>
            ...
            <div style={{
                ...
                <p style={{ margin: 0, color: '#6b7280', fontSize: '14px', lineHeight: '1.6' }}>
                    {t(
                        `This grouped bar chart displays ${(settings.metricType === 'pvalue' || settings.metricType === 'p_value') ? 'p-values' : 'Chi-Square statistics'} across different variable comparisons. Each group of bars represents a primary variable, with individual bars showing its relationship strength with other variables. Self-comparisons are automatically excluded.`,
                        `এই গ্রুপড বার চার্টটি বিভিন্ন ভেরিয়েবল তুলনায় ${(settings.metricType === 'pvalue' || settings.metricType === 'p_value') ? 'পি-মান' : 'কাই-স্কয়ার পরিসংখ্যান'} প্রদর্শন করে। প্রতিটি বার গ্রুপ একটি প্রাথমিক ভেরিয়েবল প্রতিনিধিত্ব করে, পৃথক বারগুলি অন্যান্য ভেরিয়েবলের সাথে এর সম্পর্কের শক্তি দেখায়। স্ব-তুলনা স্বয়ংক্রিয়ভাবে বাদ দেওয়া হয়।`
                    )}
                </p>
            </div>
        </div>
