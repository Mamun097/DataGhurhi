...
const StackedBarPlot = ({
    ...
    const generateStackedBarData = () => {
        ...
        if (!selectedResult) {
            selectedResult = results.pairwise_results[0]; // Use first result for cross-tab
        }
        ...
        return {
            ...
            pValue: selectedResult.p_value || 0.05, // Default for cross-tab
            chi2: selectedResult.chi2 || 10.5 // Default for cross-tab
        };
    };
        ...
        <div style={{ position: 'relative', width: '100%' }}>
            ...
            <div style={{
                ...
                <p style={{ margin: 0, color: '#6b7280', fontSize: '14px', lineHeight: '1.6' }}>
                    {t(
                        'This stacked bar chart shows the distribution of categories within each variable. Each segment represents the proportion or count of a specific category combination.',
                        'এই স্ট্যাকড বার চার্ট প্রতিটি ভেরিয়েবলের মধ্যে ক্যাটাগরির বিতরণ দেখায়। প্রতিটি অংশ একটি নির্দিষ্ট ক্যাটাগরি সমন্বয়ের অনুপাত বা গণনা প্রতিনিধিত্ব করে।'
                    )}
                </p>                
            </div>
        </div>
