                            ...
                            <div className="setting-group">
                                ...
                                <select
                                    ...
                                    onChange={(e) => {
                                        ...
                                        let newYAxisTitle = '';
                                        if (newMetricType === 'p_value') newYAxisTitle = 'P-Value';
                                        else if (newMetricType === 'chi2') newYAxisTitle = 'Chi-Square Statistic';
                                        else if (newMetricType === 'frequency') newYAxisTitle = 'Frequency';
                                        else if (newMetricType === 'normalized_frequency') newYAxisTitle = 'Normalized Frequency';
                                ...
                                >
                                    ...
                                    <option value="normalized_frequency">Normalized Frequency</option>
                                </select>
                            </div>
                        )}
