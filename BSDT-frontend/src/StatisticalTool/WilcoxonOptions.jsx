...
import './WilcoxonOptions.css';

const WilcoxonOptions = ({
    isFirstTimeAnalysis,
    ...
    // detect changes between tempValues and current props
    useEffect(() => {
        const changed =
    ...
    }, [tempValues, imageFormat, labelFontSize, tickFontSize, imageQuality, imageSize, colorPalette, barWidth, boxWidth, showGrid]); //violinWidth,

    // if pending regenerate and props updated, call handleSubmit
    useEffect(() => {
    ...
    }, [imageFormat, labelFontSize, tickFontSize, imageQuality, imageSize, colorPalette, barWidth, boxWidth,  showGrid, tempValues]); //violinWidth,
    ...
    return (
        <div className="wilcoxon-options-container">
                            ...
                            {isFirstTimeAnalysis ? (
                                ...
                                >
                                    <span style={{ position: 'relative', width: '16px', height: '16px', display: 'inline-block', flexShrink: 0 }}>
                                        <span className="spinner" style={{ position: 'absolute', top: 0, left: 0, visibility: isRegenerating ? 'visible' : 'hidden' }} />
                                    ...
                                    <span style={{ marginLeft: 8 }}>
                                        {isRegenerating ? (language === 'bn' ? 'পুনরায় তৈরি করা হচ্ছে...' : 'Regenerating...') : (t.generateAgain || (language === 'bn' ? 'পুনরায় তৈরি করুন' : 'Generate Again'))}
                                    </span>
                                </button>
                            )}
                        </div>
...
export default WilcoxonOptions;
