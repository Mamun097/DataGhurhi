// src/components/options/EDABasicsOptions.js

import React from 'react';

const EDABasicsOptions = ({
    language,
    setLanguage,
    imageFormat,
    setImageFormat,
    ...
    return (
        <div className="mt-4 border-t pt-4">
            <h4 className="font-semibold text-lg mb-3">{t.eda_basicsTitle || "Basic EDA Summary"}</h4>
...
export default EDABasicsOptions;
