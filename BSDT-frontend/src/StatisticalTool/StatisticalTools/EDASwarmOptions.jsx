const EDASwarmOptions = ({
    ...
    return (
        <div className="mt-4 border-t pt-4">
            <h4 className="font-semibold text-lg mb-3">{t.edaSwarmTitle}</h4>
            ...
            {!useDefaultSettings && (
                <div className="bg-white shadow rounded-lg p-6 mt-4 border border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        {/* Swarm Color */}
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">{t.swarmColor}</label>
                            <input
                                type="text"
...
export default EDASwarmOptions;
