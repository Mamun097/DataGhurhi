const ShapiroWilkOptions = ({
    ...
    return (
        <div className="mt-4 border-t pt-4">
            <h4 className="font-semibold text-lg mb-3">{t.tests.shapiro || 'Shapiro-Wilk Normality Test'}</h4>
            ...
            {!useDefaultSettings && (
                <div className="bg-white shadow rounded-lg p-6 mt-4 border border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        {/* Histogram Bins */}
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">{language === 'bn' ? 'হিস্টোগ্রাম বিন' : 'Histogram Bins'}</label>
                            <input
                                type="number"
                                min={1}
                                className="w-full border border-gray-300 rounded-md px-3 py-2"
                        ...
                        {/* Bar Color */}
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">{language === 'bn' ? 'বার রঙ' : 'Bar Color'}</label>
                            <input
                                type="text"
