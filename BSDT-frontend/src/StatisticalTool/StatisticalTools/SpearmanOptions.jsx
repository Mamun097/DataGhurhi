const SpearmanOptions = ({ language, options, setOptions, t }) => {
  ...
  return (
    <div className="mt-4 border-t pt-4">
      <h4 className="font-semibold text-lg mb-3">{t.tests.spearman}</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("barWidth", Number(e.target.value))
                }
              />
            </div>
          </div>
...
export default SpearmanOptions;
